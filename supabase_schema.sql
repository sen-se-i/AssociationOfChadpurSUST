...
-- 4. PEOPLE INFORMATION (with social links)
-- ------------------------------------------------------------------------------
...
-- General Members
INSERT INTO public.people (category, name, dept, area, session, display_order) VALUES
('general', 'Mehedi Hasan Tareq', 'Software Engineering', 'Haimchar', '21-22', 1),
('general', 'Priya Rani', 'Computer Science & Engineering', 'Haimchar', '22-23', 2),
('general', 'Sami', 'Software Engineering', 'Chandpur Sadar', '22-23', 3),
('general', 'Tasnova Tamacchin Nihat', 'Software Engineering', 'Chandpur Sadar', '22-23', 4),
('general', 'Al-Amin Mollik', 'Mechanical Engineering', 'Faridganj', '22-23', 5),
('general', 'Mahbubur Rahman Mahi', 'Chemical Engineering & Polymer Science', 'Chandpur Sadar', '22-23', 6),
('general', 'Sayad Ahmed', 'Food Engineering & Tea Technology', 'Chandpur Sadar', '22-23', 7),
('general', 'Mohammad Atikur Rahman Ratul', 'Electrical & Electronic Engineering', 'Chandpur Sadar', '23-24', 8),
('general', 'Saliha Rahman', 'Sociology', 'Faridganj', '23-24', 9),
('general', 'Muslim Talukder Rifat', 'Statistics', 'Chandpur Sadar', '24-25', 10),
('general', 'Ariyan Rahman Shanil', 'Statistics', 'Haimchar', '24-25', 11),
('general', 'Mohammad Mostafizur Rahman', 'Statistics', 'Matlab Uttar', '24-25', 12),
('general', 'Md Sajid Hossean', 'Statistics', 'Faridganj', '24-25', 13),
('general', 'Musfiq Ahmad', 'Statistics', 'Faridganj', '24-25', 14),
('general', 'Manjur Hasan Fahim', 'Software Engineering', 'Chandpur Sadar', '24-25', 15),
('general', 'Imtiyaz Ahmed Emon', 'Software Engineering', 'Kachua', '24-25', 16),
('general', 'Zakaria Morshed', 'Software Engineering', 'Chandpur Sadar', '24-25', 17),
('general', 'Muhammad Iftekharul Islam', 'Physics', 'Chandpur Sadar', '24-25', 18),
('general', 'Sabit Ahnaf', 'Physics', 'Kachua', '24-25', 19),
('general', 'Nowshin Mahmud Chamak', 'Physics', 'Matlab Uttar', '24-25', 20),
('general', 'Tanzim Ahmed Mahim', 'Chemistry', 'Matlab Uttar', '24-25', 21),
('general', 'Iqbal Sami', 'Chemistry', 'Haziganj', '24-25', 22),
('general', 'Farhan Sadeque', 'Forestry & Environmental Science', 'Kachua', '24-25', 23),
('general', 'Rakibul Hasan Moin', 'Forestry & Environmental Science', 'Kachua', '24-25', 24),
('general', 'Tanvir Hassan', 'Business Administration', 'Kachua', '24-25', 25),
('general', 'Md Nabil Khan', 'Business Administration', 'Chandpur Sadar', '24-25', 26),
('general', 'Md Farhan Muntasir Nehal', 'Electrical & Electronic Engineering', 'Kachua', '24-25', 27),
('general', 'Md Hasebul Hasan Rippy', 'Civil & Environmental Engineering', 'Haimchar', '24-25', 28),
('general', 'Swastika Naha Arpa', 'Chemical Engineering & Polymer Science', 'Chandpur Sadar', '24-25', 29),
('general', 'Arifa Binta Alam', 'Food Engineering & Tea Technology', 'Haziganj', '24-25', 30),
('general', 'Noor Hossain Alif', 'Geography & Environment', 'Faridganj', '24-25', 31),
('general', 'Md Moshiur Rahman Sami', 'Oceanography', 'Chandpur Sadar', '24-25', 32),
('general', 'Mishkat Jahan Mithila', 'Public Administration', 'Chandpur Sadar', '24-25', 33),
('general', 'Md Sabbir Ahmed Osmani', 'Political Studies', 'Kachua', '24-25', 34),
('general', 'Sabrina Sarmin Tanisha', 'Social Work', 'Chandpur Sadar', '24-25', 35),
('general', 'Saiem Qibria', 'Industrial & Production Engineering', 'Matlab Uttar', '24-25', 36);

-- Teachers from Chandpur
INSERT INTO public.people (category, name, dept, position, display_order) VALUES
('teacher', 'Dr S M Saiful Islam', 'Chemistry', 'Professor', 1),
('teacher', 'Dr. Md Zakir Hossain', 'Statistics', 'Professor', 2),
('teacher', 'Dr. Mirza Nazmul Hasan', 'Statistics', 'Professor', 3),
('teacher', 'Dr. Mohammad Jasim Uddin', 'Sociology', 'Professor', 4),
('teacher', 'Dr Mohammad Abdul Hannan', 'Economics', 'Professor', 5),
('teacher', 'Dr Masud Alam', 'Economics', 'Professor', 6),
('teacher', 'Dr. Nur Mohammad Majumder', 'Anthropology', 'Professor', 7),
('teacher', 'Dr. Nilufa Aktar', 'Bangla', 'Professor', 8),
('teacher', 'Dr Mohammad Razaul Karim', 'Chemistry', 'Professor', 9),
('teacher', 'Syed Towfiq Mahmood Hasan', 'Business Administration', 'Associate Professor', 10),
('teacher', 'Mohammad Abdullah-Al-Shoeb', 'Biochemistry and Molecular Biology', 'Associate Professor(On leave)', 11),
('teacher', 'Dr Mohammad Shaiful Alam Amin', 'Chemical Engineering & Polymer Science', 'Professor', 12),
('teacher', 'Shahla Safwat Ravhee', 'Architecture', 'Assistant Professor(On leave)', 13),
('teacher', 'Md. Syamul Bashar', 'Mechanical Engineering', 'Assistant Professor', 14),
('teacher', 'Md. Mahin Uddin', 'Geography and Environment', 'Lecturer', 15),
('teacher', 'Mahabub Alam', 'FET', 'Lecturer', 16);

-- Staff from Chandpur
INSERT INTO public.people (category, name, dept, position, display_order) VALUES
('staff', 'Mr. Helan Hossain Dewan', 'Accounts', 'Assistant Director', 1),
('staff', 'Mr. Md. Hasan Mahmud Khan', 'IICT', 'Technician', 2),
('staff', 'Mr. Md. Farkul Islam', 'Registrar Office', 'Administrative Officer', 3),
('staff', 'Mr. Md. Khoka Mia', 'Chemistry', 'Senior Lab Assistant', 4),
('staff', 'Mr. Md. Nazrul Islam', 'Civil', 'Instrument Engineer', 5),
('staff', 'Mr. Md. Nasir Uddin Bepari', 'Registrar Office', 'Senior Guest House Attendant', 6),
('staff', 'Mr. Md. Babul Hossain', 'FES', 'Technician Officer', 7),
('staff', 'Mr. Abu Yusuf', 'Research Center', 'N/A', 8),
('staff', 'Mr. Abdul Karim', 'Mathematics', 'Office Attendant', 9),
('staff', 'Mr. Md. Jakir Hossain', 'Registrar Office', 'Office Assistant', 10),
('staff', 'Ms. Rina Ferdousi', 'Medical', 'Nurse', 11),
('staff', 'Mr. Monir Hossain', 'Transport', 'Senior Driver', 12),
('staff', 'Mr. Alauddin Shah', 'Telephone', 'Senior Operator', 13),
('staff', 'Ms. Farhana Begum', 'Female Hall', 'Assistant', 14),
('staff', 'Mr. Md. Jitu Mia', 'Anthropology', 'Administrative Officer', 15),
('staff', 'Mr. Md. Taslim Dewan', 'Registrar Office', 'Senior Guard', 16),
('staff', 'Mr. Imam Hossain', '2nd Female Hall', 'Senior Guard', 17),
('staff', 'Mr. Abdur Rob', 'Registrar Office', 'Security Assistant', 18),
('staff', 'Mr. Anisur Rahman', 'VC Bungalow', 'Senior Gardener', 19),
('staff', 'Mr. Shahjahan Molla', 'IPE', 'Office Attendant', 20),
('staff', 'Mr. Md. Sohel Ahmed', 'IPE', 'Office Attendant', 21);
